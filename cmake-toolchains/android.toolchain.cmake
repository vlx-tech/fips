...
if (${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Darwin") 
    ...
    get_filename_component(ANDROID_NDK_ROOT "../../fips-sdks/osx/${ANDROID_NDK_NAME}" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
    get_filename_component(ANDROID_SDK_ROOT "../../fips-sdks/osx/android-sdk-macosx" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
    set(ANDROID_NDK_EXE_EXT "")
    set(ANDROID_SDK_TOOL_EXT "")
elseif (${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux")
    set(ANDROID_NDK_HOST "linux-x86_64")
    get_filename_component(ANDROID_NDK_ROOT "../../fips-sdks/linux/${ANDROID_NDK_NAME}" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
    get_filename_component(ANDROID_SDK_ROOT "../../fips-sdks/linux/android-sdk-linux" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
    set(ANDROID_NDK_EXE_EXT "")
    set(ANDROID_SDK_TOOL_EXT "")
elseif (${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Windows")
    set(ANDROID_NDK_HOST "windows")
    get_filename_component(ANDROID_NDK_ROOT "../../fips-sdks/win/${ANDROID_NDK_NAME}" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
    get_filename_component(ANDROID_SDK_ROOT "../../fips-sdks/win/android-sdk-windows" ABSOLUTE BASE_DIR ${CMAKE_CURRENT_LIST_DIR})
